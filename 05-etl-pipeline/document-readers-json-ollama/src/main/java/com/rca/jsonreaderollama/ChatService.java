...
public class ChatService {
    ...
    String chatWithDocument(String message){
        var systemPromptTemplate = """
                ...
                Use the information from DOCUMENTS section to provide accurate answers.If unsure or if the answer
        ...
        //Searching the similar documents based on the similarity in the context behind.
